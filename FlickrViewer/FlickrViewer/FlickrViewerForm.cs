...
namespace FlickrViewer
{
    public partial class FlickrViewerForm : Form
    {
        ...
        private const string KEY = "f9e0b24e73f74cd8afb52c323a479f93";
        ...
        private async void searchButton_Click(object sender, EventArgs e)
        {
            ...
            var flickrURL = string.Format("https://www.flickr.com/services/rest/?method=flickr.photos.search&api_key={0}&tags={1}&tag_mode=all&privacy_filter=1&per_page=500&format=rest", KEY, inputTextBox.Text.Replace(" ", ","));
